    ...
    >
      <div className='text-white flex flex-col justify-center items-centers' style={poppins.style}>
        <div className='leading-none'>
          ...
          {/* <h1 className='text-xl lg:text-6xl font-bold'>Pusat Penelitian</h1>
          <h1 className='text-xl lg:text-6xl font-bold'>dan Pengembangan</h1>
          <h1 className='text-xl lg:text-6xl font-bold'>BMKG</h1> */}
        </div>
