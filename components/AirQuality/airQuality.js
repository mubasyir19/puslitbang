        ...
        >
          <SwiperSlide className='card w-56 p-7 text-white rounded-3xl bg-gradient-to-br from-yellow-300 to-green-600'>
            ...
            <div className='mt-6 flex gap-x-2 justify-center'>
              ...
              <div>
                <p className='text-2xl text-white'>Jakarta</p>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide className='card w-56 p-7 text-white rounded-3xl bg-gradient-to-br from-blue-500 to-indigo-800'>
            <div className='top-card flex justify-between'>
              <p className='text-lg'>
                PM<span className='text-xs'>2.5</span>
              </p>
              <p className='my-auto text-base text-right'>Sedang</p>
            </div>
            <div className='mt-12 mx-auto border-8 border-white rounded-full w-32 h-32 flex justify-center items-center'>
              <p className='text-4xl'>31.6</p>
            </div>
          ...
          <SwiperSlide className='card w-56 p-7 text-white rounded-3xl bg-gradient-to-br from-yellow-400 via-yellow-400 to-red-500'>
            <div className='top-card flex justify-between'>
              <p className='text-lg'>
                PM<span className='text-xs'>2.5</span>
              </p>
              <p className='my-auto text-base text-right'>Tidak Sehat</p>
            </div>
            <div className='mt-12 mx-auto border-8 border-white rounded-full w-32 h-32 flex justify-center items-center'>
              <p className='text-4xl'>31.6</p>
            </div>
          ...
          <SwiperSlide className='card w-56 p-7 text-white rounded-3xl bg-gradient-to-br from-rose-500 to-red-900'>
            <div className='top-card flex justify-between'>
              <p className='text-lg'>
                PM<span className='text-xs'>2.5</span>
              </p>
              <p className='my-auto text-base text-right'>Sangat Tidak Sehat</p>
            </div>
            <div className='mt-12 mx-auto border-8 border-white rounded-full w-32 h-32 flex justify-center items-center'>
              <p className='text-4xl'>31.6</p>
            </div>
          ...
          <SwiperSlide className='card w-56 p-7 text-white rounded-3xl bg-gradient-to-br from-gray-900 to-black'>
            <div className='top-card flex justify-between'>
              <p className='text-lg'>
                PM<span className='text-xs'>2.5</span>
              </p>
              <p className='my-auto text-base text-right'>Bahaya</p>
            </div>
            <div className='mt-12 mx-auto border-8 border-white rounded-full w-32 h-32 flex justify-center items-center'>
              <p className='text-4xl'>31.6</p>
            </div>
